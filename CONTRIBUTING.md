# Contribute to bankIO Power BI PSD2/OpenBanking API data connector

Thank you for your interest in bankIO Power BI PSD2/OpenBanking API data connector!
...
You can contribute to [bankIO Link](https://bankio.co.uk/bankio-link/) Power BI PSD2/OpenBanking API data connector in these ways:

- Contribute to code via the [public bankIO developer docs repository](https://github.com/bank-io/bankIO-power-bi-data-connector)
- Report documentation bugs via [GitHub Issues](https://github.com/bank-io/bankIO-power-bi-data-connector/issues)
...
```cmd
git clone https://github.com/{your user name}/bankIO-power-bi-data-connector.git
```

Next, create a reference to the root repository by entering these commands:

```cmd
cd bankIO-power-bi-data-connector
git remote add upstream https://github.com/bank-io/bankIO-power-bi-data-connector.git
git fetch upstream
```
...
4. Ensure that the Base branch is `bank-io/bankIO-power-bi-data-connector@master` and the Head branch is `<your username>/bankIO-power-bi-data-connector@<branch name>`.
...
Your pull request will surface on the bank-io/bankIO-power-bi-data-connector site under Issues.
...
For example, suppose your local branch X was successfully merged into the bank-io/bankIO-power-bi-data-connector master branch and you want to make additional updates to the content that was merged.
Create a new local branch, X2, from the bank-io/bankIO-power-bi-data-connector master branch.
